...
void loop() {
  ...
  //You can change value "400", we found it by serial printing the values from the photoresistor under normal conditions
  if (value < 400) {
 
    lcd.setCursor(0, 0);         // move cursor to   (0, 0)
    lcd.print("winner is ");        // print message at (0, 0)
    lcd.setCursor(2, 1);         // move cursor to   (2, 1)
    lcd.print("in line 1"); // print message at (2, 1)
  }
  //You can change value "400", we found it by serial printing the values from the photoresistor under normal conditions
  if (value1 < 400) {
    ...
    lcd.print("winner is ");        // print message at (0, 0)
    lcd.setCursor(2, 1);         // move cursor to   (2, 1)
    lcd.print("in line 2"); // print message at (2, 1)
  }
  if (value2 < 400) {
    ...
    lcd.print("winner is ");        // print message at (0, 0)
    lcd.setCursor(2, 1);         // move cursor to   (2, 1)
    lcd.print("in line 3"); // print message at (2, 1)
  }
  if (value3 < 400) {
    ...
    lcd.print("winner is ");        // print message at (0, 0)
    lcd.setCursor(2, 1);         // move cursor to   (2, 1)
    lcd.print("in line 4"); // print message at (2, 1)
  }
